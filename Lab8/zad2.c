...
/*Napisać odpowiednie makrodefinicje i ich wywołania, żeby został wygenerowany tekst
 	Najwyzszym szczytem Azji jest Mt. Everest.
...
INFO(Australii, Gora Kosciuszki)
